  ...
  return <div className="flex flex-wrap items-center gap-1 px-7 pb-6 sm:px-14">
    ...
    <details className="group relative">
      ...
      <div className="absolute bottom-10 left-0 z-10 grid w-32 gap-0.5 rounded-lg border border-[#e6dcd2] bg-[#fffdf9] p-1.5 shadow-[0_12px_28px_rgba(76,51,35,0.12)]">
        <button className="rounded-md px-2.5 py-2 text-left text-xs text-[#68594e] hover:bg-[#f7eee6]" onClick={onExportPDF}>PDF</button>
        <button className="rounded-md px-2.5 py-2 text-left text-xs text-[#68594e] hover:bg-[#f7eee6]" onClick={onExportDOCX}>Word document</button>
        <button className="rounded-md px-2.5 py-2 text-left text-xs text-[#68594e] hover:bg-[#f7eee6]" onClick={onExportTXT}>Plain text</button>
      </div>
    </details>
